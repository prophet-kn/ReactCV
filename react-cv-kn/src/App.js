              ...
              if (e !== undefined) {
                return (
                  <div key={k} className={"edu cv-col"}>
                    ...
                    {e.thesis !== undefined ? e.thesis : null}
                  </div>
                )
              }
              else {
